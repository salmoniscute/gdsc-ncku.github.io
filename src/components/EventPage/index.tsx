...
export default function Event(): React.ReactElement {
    return (
        <div id="event">
            ...
            <YearEvent image={SolutionChallenge} borderColor="#EA4336" name="Solution Challenge" infor="Google Study Jam 培訓計劃，讓參加的開發人員能夠以自己的步調，學習多種 Google 產品的基礎技能，過去曾經舉辦的主題有 Android、Machine learning、GenAI。在最近的 GenAI 主題中，除了學習基礎的 Google Cloud 平台之外，也增加關於 Generative AI 相關的服務，完成挑戰還能獲得官方製作的相關紀念品喔。" link="https://rsvp.withgoogle.com/events/csj-tw-s4"/>
